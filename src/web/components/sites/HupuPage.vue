...
const siteConfig = getSiteConfig('hupu')!
...
async function handleExecute(
  ...
  try {
    const response = await fetch('/api/sites/hupu/execute', {
      method: 'POST',
...
.site-header::before {
  ...
  right: 0;
  bottom: 0;
  background: url("data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23ffffff' fill-opacity='0.1' fill-rule='evenodd'%3E%3Ccircle cx='10' cy='10' r='3'/%3E%3C/g%3E%3C/svg%3E");
  opacity: 0.5;
}
